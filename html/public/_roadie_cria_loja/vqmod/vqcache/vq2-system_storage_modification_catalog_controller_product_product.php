...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
            ...
            $data["entry_simulate_shipping"] = $this->language->get('entry_simulate_shipping');
            $data["entry_postcode"] = $this->language->get('entry_postcode');
            $data["entry_calculate_shipping"] = $this->language->get('entry_calculate_shipping');
            $data["entry_calculate_loading"] = $this->language->get('entry_calculate_loading');
...
$data['price_value'] = $product_info['price'];
          ...
          $data['config_display_kitoptions'] = $this->config->get('config_display_kitoptions');
			$data['options'] = array();
			...
			foreach ($this->model_catalog_product->getProductOptions($this->request->get['product_id']) as $option) {
				...
				foreach ($option['product_option_value'] as $option_value) {
					if (!$option_value['subtract'] || ($option_value['quantity'] > 0)) {
						...
						$product_option_value_data[] = array(
'price_value_tax'               => $option_value['price'],
