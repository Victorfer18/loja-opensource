...
<optgroup label="<?php echo $text_choose; ?> com quantidade">
...
$('select[name=\'type\']').on('change', function() {
	if (this.value == 'select' || this.value == 'checkbox_qty' || this.value == 'radio_qty' || this.value == 'select_qty' || this.value == 'radio' || this.value == 'checkbox' || this.value == 'image') {
		$('#option-value').show();
	} else {
		$('#option-value').hide();
	}
