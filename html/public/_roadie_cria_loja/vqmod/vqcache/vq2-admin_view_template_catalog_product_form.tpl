                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-option<?php echo $option_row; ?>">
                      ...
                      <?php } ?>
                      <?php if ($product_option['type'] == 'select' || $product_option['type'] == 'checkbox_qty' || $product_option['type'] == 'radio_qty' || $product_option['type'] == 'select_qty' || $product_option['type'] == 'radio' || $product_option['type'] == 'checkbox' || $product_option['type'] == 'image') { ?>
                      <div class="table-responsive">
...
$('input[name=\'option\']').autocomplete({
	...
	'select': function(item) {
		...
		if (item['type'] == 'select' || item['type'] == 'checkbox_qty' || item['type'] == 'radio_qty' || item['type'] == 'select_qty' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
